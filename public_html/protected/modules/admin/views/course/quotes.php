...
<ul class="nav nav-tabs">
	<li><?php echo CHtml::link('Details', array('course/update', 'id'=>$Event->id)); ?></li>
	<li><?php echo CHtml::link('Options', array('course/options', 'id'=>$Event->id)); ?></li>
	<li class="active"><?php echo CHtml::link('Quotes', array('course/quotes', 'id'=>$Event->id)); ?></li>
</ul>
<div class="row">
	<div class="span5">
