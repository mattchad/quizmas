...
<ul class="nav nav-tabs">
	<li class="active"><?php echo CHtml::link('Details', array('course/update', 'id'=>$model->id)); ?></li>
	<li><?php echo CHtml::link('Options', array('course/options', 'id'=>$model->id)); ?></li>
	<li><?php echo CHtml::link('Quotes', array('course/quotes', 'id'=>$model->id)); ?></li>
</ul>
